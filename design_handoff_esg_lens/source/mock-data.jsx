// Mock data for ESG Lens screens — Apex Hydrocarbon (high-risk default)
...
const MOCK = {
  ...
  emissions: [
    // year, actual MtCO2e, pledged target MtCO2e
  ...
  greenlighting: [
    { label: "Marketing focus", value: 82, color: "orange" },
    { label: "Green revenue (claimed)", value: 45, color: "amber" },
    { label: "Green revenue (verified)", value: 11.8, color: "green-text" },
    { label: "Green CapEx (actual)", value: 6.1, color: "red" },
  ],
